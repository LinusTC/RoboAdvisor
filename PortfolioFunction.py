...
def get_matrices(df, halflife=20):
    ...
    unweighted_annaulized_returns = ewm_returns.mean() * 252
    ...
    return df.columns.tolist(), annaulized_returns, unweighted_annaulized_returns, ewm_returns, normal_returns, cov_matrix, correlation_matrix
